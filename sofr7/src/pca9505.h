...
// Rest of your pca9505.h content remains the same...
void matrix_init_custom(void);
bool matrix_scan_custom(matrix_row_t current_matrix[]);
...
static const pca9505_pin_t MATRIX_PIN_MAP[6][16] = {
    ...
    // Row 2: Tab, Q-P, [, ], \, PgUp
    {
        ...
        {0x21, 1, 3},  // K44 - [
        {0x21, 1, 4},  // K45 - ]
        {0x21, 1, 5},  // K46 - backslash   
        {0x21, 1, 6},  // K47 - backslash     (same key)
        {0x21, 1, 7},  // K48 - PgUp
    },
    // Row 3: Caps, A-L, ;, ', Enter, PgDn
    {
        {0x21, 2, 0},  // K49 - Caps Lock
        {0x21, 2, 1},  // K50 - A
        {0x21, 2, 2},  // K51 - S
        {0x21, 2, 3},  // K52 - D
        {0x21, 2, 4},  // K53 - F
        ...
        {0x21, 3, 3},  // K60 - '
        {0x21, 3, 4},  // K61 - Enter
        {0x21, 3, 5},  // K62 - Enter (same key)
        {0x21, 3, 6},  // K63 - Enter (same key)
        {0x21, 3, 7},  // K64 - PgDn
    },
    // Row 4: LShift, Z-M, ,, ., /, RShift, Up, End
    {
        {0x22, 0, 0},  // K65 - LShift
        {0x22, 0, 1},  // K66 - LShift (same key)
        {0x22, 0, 2},  // K67 - Z
        {0x22, 0, 3},  // K68 - X
        {0x22, 0, 4},  // K69 - C
        {0x22, 0, 5},  // K70 - V
    ...
    // Row 5: LCtrl, Win, LAlt, Space, RAlt, Fn, RCtrl, Left, Down, Right
    {
        ...
        {0x22, 2, 2},  // K83 - LAlt
        {0x22, 2, 3},  // K84 - Space
        {0x22, 2, 4},  // K85 - Space (same key)
        {0x22, 2, 5},  // K86 - Space (same key)
        {0x22, 2, 6},  // K87 - Space (same key)
        {0x22, 2, 7},  // K88 - Space (same key)
        {0x22, 3, 0},  // K89 - Space (same key)
        {0x22, 3, 1},  // K90 - RAlt
        {0x22, 3, 2},  // K91 - Fn
        {0x22, 3, 3},  // K92 - RCtrl
        {0x22, 3, 4},  // K93 - Left
